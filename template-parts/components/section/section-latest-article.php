...
<?php
$data = array_reverse(emk_options("home-last-article"));
?>
...
<div class="py-16 md:py-28 relative block space-y-8 md:space-y-12">
	...
	<?php if (!empty(emk_options("home-last-article"))): ?>
		<!-- body -->
...
//					echo "</pre>";
						...
						while ($meta_query->have_posts()) {
							...
							<div class="col-span-1 md:col-span-4 rounded-2xl md:rounded-3xl bg-white overflow-hidden transition duration-300 hover:shadow-md flex flex-row md:block">
								...
								<div class="p-4 md:p-8 flex flex-col items-start justify-center gap-2 md:gap-4">
									<a href="" class="text-lg md:text-3xl font-bold text-scheme-green line-clamp-2 min-h-[50px]">
										<?= get_the_title(get_the_ID())?>
									</a>
									<p class="text-sm md:text-base line-clamp-2 text-scheme-gray line-clamp-3 overflow-y-hidden">
										lorem ipsum dolor sit amet lorem ipsum do lorem ipsum dolor sit amet lorem ipsum do lorem ipsum dolor sit amet lorem ipsum do lorem ipsum dolor sit amet lorem ipsum dlorem ipsum dolor sit amet lorem ipsum dolorem ipsum dolor sit amet lorem ipsum do lorem ipsum dolor sit amet lorem ipsum do
									</p>
					...
					wp_reset_query();
					?>
					<!--					<div class="animate-pulse col-span-1 md:col-span-4 rounded-2xl md:rounded-3xl bg-white overflow-hidden transition duration-300 hover:shadow-md flex flex-row md:block">-->
					<!--						<div class="h-full w-[32rem] md:w-auto xl:h-52 2xl:h-72 overflow-hidden bg-gray-200">-->
					<!---->
					<!--						</div>-->
					<!---->
					<!--						<div class="p-4 md:p-8 flex flex-col items-start justify-center gap-2 md:gap-4">-->
					...
					<!--							<div class="w-full h-3 bg-gray-200 rounded-full"></div>-->
					<!--							<div class="px-6 py-2 bg-gray-200 rounded-full"></div>-->
					<!--						</div>-->
					<!--					</div>-->
