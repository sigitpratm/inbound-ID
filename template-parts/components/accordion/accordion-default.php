...
$arguments  = [
	// card-default
	'title' => 'Frequently Answer Questions',
	'data'     => [],
];
...
<div class="flex justify-center items-start my-2">
	<div class="w-full">
		<h2 class="text-xl font-semibold text-vnet-blue mb-2"><?= esc_html($args['title']) ?></h2>
		<ul class="flex flex-col">
			<?php  foreach ($args['data'] as $k => $item): $key = $k+1;?>
			<li class="bg-white my-2 shadow-md rounded-md" x-data="accordion(<?= $key?>)">
				<h2
					@click="handleClick()"
					class="text-gray-700 flex flex-row justify-between items-center font-semibold p-3 cursor-pointer"
				>
