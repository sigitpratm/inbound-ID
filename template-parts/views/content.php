	...
	<div class="flex flex-col items-center justify-center gap-12">
		...
		<a href="#">
			<svg xmlns="http://www.w3.org/2000/svg" baseProfile="tiny" version="1.2" viewBox="0 0 24 24"
				...
				<ellipse xmlns="http://www.w3.org/2000/svg" cx="6.5" cy="6.5" rx="1.55" ry="1.5"></ellipse>
			</svg>
		</a>
...
<div class="py-[6.5rem] container px-4 lg:px-16 xl:px-12 2xl:px-0 mx-auto z-30 relative">
...
<!-- last section -->
<div class="grid grid-cols-12 relative bg-scheme-light-gray relative z-20">
	...
	<div class="col-span-12 md:col-span-6 lg:px-24 xl:px-32 2xl:px-44 relative z-40">
		<div class="w-full h-full flex flex-col items-center justify-center space-y-8 md:space-y-16 pt-8 md:pt-0 pb-32 md:pb:0 px-4 md:px-0">
			...
			<div class="flex flex-col justify-center gap-4">
				<button class="min-w-[16rem] bg-scheme-green py-4 xl:py-4 2xl:py-6 flex-none text-center rounded-full font-bold text-white transition duration-200 hover:shadow-lg">
					Create a Brief
				</button>
