...
class acf {
	...
	function wp_init() {
		...
		$scripts['select2'] = array(
			'src'	=> get_template_directory_uri().'/inc/plugins/acf/assets/inc/select2/select2.min.js',
			'deps'	=> array('jquery')
		);
		
		$scripts['acf-input'] = array(
			'src'	=> get_template_directory_uri().'/inc/plugins/acf/assets/js/acf-input.min.js',
			'deps'	=> false
		);
		
		$scripts['acf-field-group'] = array(
			'src'	=> get_template_directory_uri().'/inc/plugins/acf/assets/js/acf-field-group.min.js',
		...
		if( $lang ) {
			...
			// attempt 1
			if( file_exists(get_template_directory_uri().'/inc/plugins/acf/assets/inc/select2/select2_locale_en.js') ) {
				
				$src = get_template_directory_uri().'/inc/plugins/acf/assets/inc/select2/select2_locale_en.js';
				
			} elseif( file_exists(get_template_directory_uri().'/inc/plugins/acf/assets/inc/select2/select2_locale_en.js') ) {
		...
		$styles['select2'] = array(
			'src'		=> get_template_directory_uri().'/inc/plugins/acf/assets/inc/select2/select2.css',
			'deps'		=> false
		);
		
		$styles['acf-datepicker'] = array(
			'src'		=> get_template_directory_uri().'/inc/plugins/acf/assets/inc/datepicker/jquery-ui-1.10.4.custom.min.css',
			'deps'		=> false
		);
		
		$styles['acf-global'] = array(
			'src'		=> get_template_directory_uri().'/inc/plugins/acf/assets/css/acf-global.css',
			'deps'		=> false
		);
		
		$styles['acf-input'] = array(
			'src'		=> get_template_directory_uri().'/inc/plugins/acf/assets/css/acf-input.css',
			'deps'		=> array('acf-global', 'wp-color-picker', 'select2', 'acf-datepicker')
		);
		
		$styles['acf-field-group'] = array(
			'src'		=> get_template_directory_uri().'/inc/plugins/acf/assets/css/acf-field-group.css',
			'deps'		=> array('acf-input')
		);
