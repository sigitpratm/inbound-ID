...
class acf_pro {
	...
	*/
	...
	function wp_init() {
		...
		// register scripts
		wp_register_script( 'acf-pro-input', get_template_directory_uri().'/inc/plugins/acf/pro/assets/js/acf-pro-input.min.js', false, acf_get_setting('version') );
		wp_register_script( 'acf-pro-field-group', get_template_directory_uri().'/inc/plugins/acf/pro/assets/js/acf-pro-field-group.min}.js', false, acf_get_setting('version') );
		
		
		// register styles
		wp_register_style( 'acf-pro-input', get_template_directory_uri().'/inc/plugins/acf/pro/assets/css/acf-pro-input.css', false, acf_get_setting('version') );
		wp_register_style( 'acf-pro-field-group', get_template_directory_uri().'/inc/plugins/acf/pro/assets/css/acf-pro-field-group.css', false, acf_get_setting('version') );
