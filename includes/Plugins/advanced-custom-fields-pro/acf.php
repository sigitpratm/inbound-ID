...
class ACF {
	...
	function initialize() {
		...
		$this->settings = array(
			...
			'path'						=> ACF_PATH,
			'file'						=> __FILE__,
			'url'						=> get_template_directory_uri( ) . '/includes/Plugins/advanced-custom-fields-pro/',
			'show_admin'				=> true,
			'show_updates'				=> true,
			'stripslashes'				=> false,
			'local'						=> true,
		...
		include_once( JIPPI_ACF_DIR . '/includes/acf-utility-functions.php');

		// Include previous API functions.
//		acf_include('includes/acf-utility-functions.php');
